	...
	-- Shortcut Bar --
		...
		WIM_LOCALIZED_COORD				= "Player Coordinates";
                WIM_LOCALIZED_TALENTSPEC                        = "Talent Spec";
	...
	-- Keybindings --
		...
		BINDING_NAME_WIMHIDEALL 			= "Hide All Messages";
                BINGING_NAME_WIMTOGGLEVIS                       = "Toggle Show/Hide All";
                BINDING_NAME_WIMMARKREAD                        = "Mark All as Read";
                BINDING_NAME_WIMFOCUSTAB                        = "Respond to Selected Tab";
	...
	-- Options Window --
		...
		WIM_LOCALIZED_OPTIONS_DISPLAY_ENABLE_FADING     = "Enable fading.";
		...
		WIM_LOCALIZED_OPTIONS_TAB_PLUGINS 		= " Plugins ";	-- notice space buffering
		...
		WIM_LOCALIZED_OPTIONS_GENERAL_SUPRESS_COMBAT    = "Except when hidden due to combat.";
                WIM_LOCALIZED_OPTIONS_GENERAL_EMOTICONS         = "Show emoticons within message windows.";
                WIM_LOCALIZED_OPTIONS_GENERAL_HOVERLINKS        = "Show tooltip when hovering over item links.";
		...
		WIM_LOCALIZED_OPTIONS_WINDOWS_SORT		= "Sort tabs by:";
		WIM_LOCALIZED_OPTIONS_WINDOWS_SORT1		= "Order Received";
		WIM_LOCALIZED_OPTIONS_WINDOWS_SORT2		= "Alphabetical";
		WIM_LOCALIZED_OPTIONS_WINDOWS_SORT3		= "Recent Activity";
		WIM_LOCALIZED_OPTIONS_WINDOWS_ONTOP		= "Keep windows on top.";
		...
		WIM_LOCALIZED_OPTIONS_PLUGINS_NOPLUGIN	 	= "No plugins are currently loaded.";
		WIM_LOCALIZED_OPTIONS_PLUGINS_NOPLUGIN_EX	= "You do not have any plugins loaded for WIM.\n\nTo download WIM sponsored plugins visit:\nhttp://www.WIMAddon.com";
		WIM_LOCALIZED_OPTIONS_PLUGINS_NOPTIONS		= "There are no available options for this plugin.";
		WIM_LOCALIZED_OPTIONS_PLUGININFO						= "Plugin Info";
	...
	-- Class Names --
		...
		WIM_LOCALIZED_GM				= "Game Master";
                
                --Account for Female locals - note english doesn't have this, so we'll inherrit from male.
                WIM_LOCALIZED_DRUID_FEMALE 			= WIM_LOCALIZED_DRUID;
		WIM_LOCALIZED_HUNTER_FEMALE 			= WIM_LOCALIZED_HUNTER;
		WIM_LOCALIZED_MAGE_FEMALE 			= WIM_LOCALIZED_MAGE;
		WIM_LOCALIZED_PALADIN_FEMALE 			= WIM_LOCALIZED_PALADIN;
		WIM_LOCALIZED_PRIEST_FEMALE 			= WIM_LOCALIZED_PRIEST;
		WIM_LOCALIZED_ROGUE_FEMALE 			= WIM_LOCALIZED_ROGUE;
		WIM_LOCALIZED_SHAMAN_FEMALE			= WIM_LOCALIZED_SHAMAN;
		WIM_LOCALIZED_WARLOCK_FEMALE 			= WIM_LOCALIZED_WARLOCK;
		WIM_LOCALIZED_WARRIOR_FEMALE 			= WIM_LOCALIZED_WARRIOR;
	...
	-- W2W Localizations --
		...
		WIM_W2W_LOCALIZED_OPTIONS_ENABLE                = "Enable (W2W) WIM-2-WIM Communication";
                WIM_W2W_LOCALIZED_OPTIONS_TYPING                = "Allow others to see you typing.";
                WIM_W2W_CAPABILITIES			        = "Capabilities";
		WIM_W2W_IS_TYPING				= "is typing...";
                WIM_W2W_TRACKMINIMAP                            = "Track on Minimap";
                WIM_W2W_TRACKMINIMAP_INFO                       = "Show on your Minimap while you are both on the same continent. You can not track while inside of an instance.";
        ...
        -- Skinner Localizations --
                ...
                WIM_SKINNER_LOCALIZED_OPTIONS_INSTD             = "Installed Skins:";
                WIM_SKINNER_LOCALIZED_OPTIONS_PREF              = "Skin Customization";
                WIM_SKINNER_LOCALIZED_OPTIONS_STYLE             = "Skin Style:";
                WIM_SKINNER_LOCALIZED_OPTIONS_FONT              = "Skin Font:";
                WIM_SKINNER_LOCALIZED_OPTIONS_DEFAULT_FONT      = "Skin's Default Font";
                WIM_SKINNER_LOCALIZED_OPTIONS_SMART_STYLE       = "Smart Style";
                WIM_SKINNER_LOCALIZED_OPTIONS_FONT_DIALOG       = "Font Selection";
                WIM_SKINNER_LOCALIZED_OPTIONS_FONT_OUTLINE      = "Font Outline:";
                WIM_SKINNER_LOCALIZED_OPTIONS_FONT_OUTLINE1     = "None";
                WIM_SKINNER_LOCALIZED_OPTIONS_FONT_OUTLINE2     = "Thin";
                WIM_SKINNER_LOCALIZED_OPTIONS_FONT_OUTLINE3     = "Thick";
                
        -- MessageBox Menu
                WIM_MSGBOX_MENU_HISTORY                         = "Sent Messages";
                WIM_MSGBOX_MENU_HISTORY_TIP                     = "Shift-Click to append to your already typed message.";
                WIM_MSGBOX_MENU_HISTORY_NONE                    = "No messages have been sent in this session.";
                WIM_MSGBOX_MENU_EMOTICONS                       = "Emoticons";
                WIM_MSGBOX_MENU_EMOTICONS_PAGE                  = "Page";
...
--[[ DEFINITION CHANGE LOG:
		...
		their localization files between updates.
                ...
                Version 2.4.0
                [+] - Added definition WIM_LOCALIZED_OPTIONS_GENERAL_EMOTICONS to Options Window section.
                [+] - Added Message Box Menu Section...
                [+] - Added definition WIM_MSGBOX_MENU_HISTORY to Message Box Menu section.
                [+] - Added definition WIM_MSGBOX_MENU_HISTORY_TIP to Message Box Menu section.
                [+] - Added definition WIM_MSGBOX_MENU_HISTORY_NONE to Message Box Menu section.
                [+] - Added definition WIM_MSGBOX_MENU_EMOTICONS to Message Box Menu section.
                [+] - Added definition WIM_MSGBOX_MENU_EMOTICONS_PAGE to Message Box Menu section.
                [+] - Added definition BINDING_NAME_WIMFOCUSTAB to Keybinding section.
                [+] - Added definition WIM_LOCALIZED_OPTIONS_GENERAL_HOVERLINKS to Options section
                
                Version 2.3.0
                [+] - Added Skinner Section.
                [+] - Added definition WIM_SKINNER_LOCALIZED_OPTIONS_DESC to SKINNER section.
                [+] - Added definition WIM_SKINNER_LOCALIZED_OPTIONS_INSTD to SKINNER section.
                [+] - Added definition WIM_SKINNER_LOCALIZED_OPTIONS_PREF to SKINNER section.
                [+] - Added definition WIM_W2W_LOCALIZED_OPTIONS_ENABLE to W2W section.
                [+] - Added definition WIM_W2W_LOCALIZED_OPTIONS_TYPING to W2W section.
                [+] - Added definition WIM_W2W_LOCALIZED_OPTIONS_STYLE to W2W section.
                [+] - Added definition WIM_W2W_LOCALIZED_OPTIONS_FONT to W2W section.
                [+] - Added definition WIM_W2W_LOCALIZED_OPTIONS_DEFAULT_FONT to W2W section.
                [+] - Added definition WIM_W2W_LOCALIZED_OPTIONS_DEFAULT_SMART_STYLE to SKINNER section.
                [+] - Added definition BINGING_NAME_WIMTOGGLEVIS to keybindings section.
                [+] - Added definition BINDING_NAME_WIMMARKREAD to keybindings section.
                [+] - Added definition WIM_SKINNER_LOCALIZED_OPTIONS_FONT_DIALOG to SKINNER section.
                [+] - Added definition WIM_SKINNER_LOCALIZED_OPTIONS_FONT_OUTLINE to SKINNER section.
                [+] - Added definition WIM_SKINNER_LOCALIZED_OPTIONS_FONT_OUTLINE1 to SKINNER section.
                [+] - Added definition WIM_SKINNER_LOCALIZED_OPTIONS_FONT_OUTLINE2 to SKINNER section.
                [+] - Added definition WIM_SKINNER_LOCALIZED_OPTIONS_FONT_OUTLINE3 to SKINNER section.
                [+] - Added definition WIM_LOCALIZED_TALENTSPEC to shortcut section.
                [+] - Added definition WIM_W2W_TRACKMINIMAP to W2W section.
                [+] - Added definition WIM_W2W_TRACKMINIMAP_INFO to W2W section.
		
		Version 2.2.0
		[+] - Added definition WIM_LOCALIZED_COORD to Shortcut section.
		[+] - Added W2W Section.
		[+] - Added definition WIM_W2W_LOCALIZED_OPTIONS_DESC to W2W section.
		
		Version 2.1.0
		[+] - Added definition WIM_LOCALIZED_GM to class section. For GM title.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_WINDOWS_SORT to window options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_WINDOWS_SORT1 to window options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_WINDOWS_SORT2 to window options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_WINDOWS_SORT3 to window options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_WINDOWS_ONTOP to window options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_GENERAL_SUPRESS_COMBAT to general options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_TAB_PLUGINS to options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_PLUGINS_NOPLUGIN to options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_PLUGINS_NOPLUGIN_EX to options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_PLUGINS_NOPTIONS to options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_PLUGININFO to options section.
		[+] - Added definition WIM_LOCALIZED_OPTIONS_DISPLAY_ENABLE_FADING to display options section.
