...
WIM.AddLocale("zhCN", {
    ...
    ["Suppress messages from the default chat frame."] = "阻止默认聊天框中的消息。",
	...
	["Never suppress messages."] = "不要拦截信息。",
	["Include emotes."] = "包含表情。",
    ["Have WIM monitor this channel."] = "WIM监控这个频道",
    ["Never Pop"] = "从不弹出",
    ["Never have this window pop-up on my screen."] = "从不弹出",
    ["Never Supress"] = "从不拦截",
    ["Never suppress messages from the default chat frame."] = "不要拦截默认聊天框中的消息。",
    ...
    ["No Sound"] = "无声",
    ["Sensitivity"] = "敏感度",
    ["Enable WorldFrame Click Detection."] = "启动世界框架点击侦测。",
